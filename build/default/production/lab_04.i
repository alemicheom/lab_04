...
;------------subrutinas_interrupciones-----------
 ...
 antirebote_iocb:
    ...
    BTFSS PORTB, 1
    DECF PORTA
    BCF ((INTCON) and 07Fh), 0 ;limpiar la bandera ((INTCON) and 07Fh), 0
...
CONFIG_IO:
 ...
 CONFIG_INT:
    ...
    BCF ((INTCON) and 07Fh), 0
    BSF ((INTCON) and 07Fh), 5 ; Habilitamos interrupción de TMR0
 ...
 CONFIG_TMR0:
    ...
    BCF ((OPTION_REG) and 07Fh), 3 ; prescaleer a TM0
    BSF ((OPTION_REG) and 07Fh), 2
    BSF ((OPTION_REG) and 07Fh), 1
    BCF ((OPTION_REG) and 07Fh), 0 ; PS <2:0> --> 110 prescaler 128
